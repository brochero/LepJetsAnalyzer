...
void Plotter(TString plots="2btag", bool LogScale=false, TString cat = "ttbb"){
  ...
  ****************/ 
  ...
  ttbar_Up   = loadhistograms(plots, files + "_ttbb_aMCatNLOPythia");
  ttbar_Down = loadhistograms(plots, files + "_ttbar_LepJetsPowhegPythia" + cat);
  ...
  for(unsigned int h=0; h<ttbar_Nom.size(); h++){
    for(int ch=0; ch<3; ch++){
      ...
      ***********************/
      ...
      leg->AddEntry((TObject*)0, "t#bar{t}b#bar{b} Comparisons","");
      leg->AddEntry((TObject*)0,"","");
      leg->AddEntry(ttbar_Nom[h].hist[ch],"t#bar{t} Tranche3","l");
      leg->AddEntry(ttbar_Up[h].hist[ch],"t#bar{t}b#bar{b} aMC@NLO","l");
      leg->AddEntry(ttbar_Down[h].hist[ch],"t#bar{t}","l");
      leg->Draw("SAME");
