...
void PrepareCombineFiles(TString FileVersion = "Full-v0", TString FileProd = "Tree_LepJets_EGTightSkim_v8-0-6_Spring16-80X_36814pb-1"){
  ...
  SysName.push_back("JER");SysName.push_back("PileUp");SysName.push_back("btagjes");SysName.push_back("btaglf");SysName.push_back("btaghf");SysName.push_back("btaghfsI");SysName.push_back("btaghfsII");SysName.push_back("btaglfsI");SysName.push_back("btaglfsII");SysName.push_back("btagcfI");SysName.push_back("btagcfII");SysName.push_back("JESAbsoluteStat");SysName.push_back("JESAbsoluteScale");SysName.push_back("JESAbsoluteMPFBias");SysName.push_back("JESFragmentation");SysName.push_back("JESSinglePionECAL"); SysName.push_back("JESSinglePionHCAL");SysName.push_back("JESFlavorQCD");SysName.push_back("JESTimePtEta");SysName.push_back("JESRelativeJEREC1"); SysName.push_back("JESRelativeJEREC2"); SysName.push_back("JESRelativeJERHF");SysName.push_back("JESRelativePtBB"); SysName.push_back("JESRelativePtEC1"); SysName.push_back("JESRelativePtEC2");SysName.push_back("JESRelativePtHF");SysName.push_back("JESRelativeBal");SysName.push_back("JESRelativeFSR");SysName.push_back("JESRelativeStatFSR"); SysName.push_back("JESRelativeStatEC"); SysName.push_back("JESRelativeStatHF");SysName.push_back("JESPileUpDataMC");SysName.push_back("JESPileUpPtRef");SysName.push_back("JESPileUpPtBB");SysName.push_back("JESPileUpPtEC1");SysName.push_back("JESPileUpPtHF");
