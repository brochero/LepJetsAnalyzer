...
def MergeCombineFiles (BaseN,SysN):
    ...
    # Samples with Systematic Variations
    TTbarNam = [basename + ttbarbase + s + sysname + ".root" for s in ttbar]
    ...
    # Samples w/o Systematic Variations 
    ...
    # ttbar: Create Full ttbar and tjj
...
PrintAndCommand("hadd " + FileHead + "_ttbar_PowhegPythiaBkgtt_SYS_AllTheory.root " + FileHead + "_ttbar_PowhegPythiaBkg_SYS_AllTheory.root " + FileHead + "_ttbar_LepJetsPowhegPythiatt_SYS_ScaleRdFUp.root " + FileHead + "_ttbar_LepJetsPowhegPythiatt_SYS_ScaleRdFDown.root " + FileHead + "_ttbar_LepJetsPowhegPythiatt_SYS_Theory.root ")
